...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            //After the code is sent to the user the user will be redirected to
            // otp verification activity using Intent
            @Override
            public void onCodeSent(final String s, PhoneAuthProvider.ForceResendingToken
                    forceResendingToken) {
...
//                            Log.w(TAG, "signInWithCredential:failure", task.getException());
    ...
    private void sendUserToHome() {
        Intent homeIntent = new Intent(LoginActivity.this, CustomerRegistrationActivity.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(homeIntent);
        finish();
